...
def getNewRPGearSepEqu():
    newEqu = "2* PI * ABS(VARVAL(." + fileName + ".VAR_reps_meas_pinionTorque_Nmm) / " + str(float(getRealValue("rpCFactor"))) + " * TAN(" + str(float(getRealValue("rpNormPressAng"))) + "d) / COS(" + str(float(getRealValue("rackHelixAng"))) + "d))"
    return newEqu
#-----------------------------------------------------------------------------------------------------------------------
